...
class SegDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        msk = transformed["mask"].ToTensor()
        sample = (img, msk)
        return sample


if __name__ == '__main__':
    rgb_txt_path = "D:/code/pytorch_template/data/train.txt"
    msk_txt_path = "D:/code/pytorch_template/data/train.txt"
    dataset = SegDataset(rgb_txt_path, msk_txt_path, 256, 256, None)
